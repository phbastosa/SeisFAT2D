...
vs = np.array([   0, 1100, 1250, 1350, 1480])
...
C11.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C11.bin")
C13.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C13.bin")
C15.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C15.bin")
C33.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C33.bin")
C35.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C35.bin")
C55.flatten("F").astype(np.float32, order = "F").tofile("../inputs/models/migration_test_C55.bin")
